    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" style="background: linear-gradient(to bottom, #99ff66 0%, #ECF0FF 100%);">
          <a class="dropdown-item" href="{{ route('users.index')}}">Llistat d'usuaris</a>
          <a class="dropdown-item" href="{{ url('admin/users/searchform')}}">Cercar un usuari</a>
          <a class="dropdown-item" href="{{ route('users.create')}}">Crear usuari nou</a>
        </div>
      </li>
    </ul>
  </div>
